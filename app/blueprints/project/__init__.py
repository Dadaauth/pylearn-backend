...
from app.blueprints.project.controllers import create_project, create_module, update_module, fetch_modules, fetch_projects_for_module, fetch_single, update_single
...
project_bp.add_url_rule('/module/<module_id>/update', view_func=update_module, methods=['PATCH'])
